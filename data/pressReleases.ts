...
export const PRESS_RELEASES: PressRelease[] = [
  {
    // RDS の release テーブル（company_id=163727 / release_id=9）に実在するプレスリリース。
    // companyId を数値にしているので、企業名から DB を正とする /companies/163727 に飛べる。
    id: "pr-163727-9",
    title:
      "静岡の町工場・杉村精工がトレイルキャップを夏季ユニフォームに導入！「町工場×スポーツ」のクールビズ",
    subtitle:
      "作業現場での熱中症対策と安全性に配慮し、製造業のイメージ刷新を目指す新たな取り組み",
    companyId: "163727",
    company: "杉村精工株式会社",
    category: "ビジネス",
    subCategory: "製造業・ものづくり",
    timestamp: "1時間前",
    publishedAt: "2026年5月8日 10時11分",
    imageUrl:
      "https://prtimes.jp/i/163727/9/resize/d163727-9-7e79f75552f8bc2ca335-2.png",
    pvCount: 56,
    likesCount: 254,
    keywords: ["町工場", "ものづくり", "製造業", "スポーツ", "静岡"],
    summaryHighlights: [
      "2026年5月から10月までの6ヶ月間、トレイルランニング用キャップを夏季ユニフォームに導入",
      "従来の作業帽より軽量・高通気でツバが短く、熱中症対策と作業時の安全性向上を両立",
      "「町工場×スポーツ」の取り組みとして、製造業のイメージ刷新を目指す",
    ],
    content: `創業77年を迎える静岡県焼津市の町工場、杉村精工株式会社（所在地：静岡県焼津市、代表取締役：杉村学）は、2026年5月から10月までの6ヶ月間、暑さ対策の一環としてトレイルランニング用キャップ（以下、トレイルキャップ）を導入します。

# トレイルキャップの特徴と導入背景

近年の全国的な気温上昇により、作業現場における熱中症対策の重要性が一層高まっています。昨夏、杉村精工においても熱中症を原因とした労働災害が1件発生したのです。

導入するキャップは、これまでにもランニングシャツやネックゲイターの製作でコラボしているランニングギアブランド「INNER-FACT（インナーファクト）」の既存製品をベースに、杉村精工オリジナルロゴをプリントした特別仕様です。

従来の作業帽と比べて軽量で通気性が高く、暑さや蒸れを軽減できて、夏場の作業時の熱中症対策につながります。また一般的なキャップよりツバが短い事が特徴です。これは周囲の視界を確保しやすく、狭い場所や機械周辺での接触リスク軽減にもつながり、作業時の安全性向上にも寄与します。

# 「町工場×スポーツ」で製造業の新たな価値を発信

本取り組みは、昨年から発信している「町工場×スポーツ」の取り組みの一環です。長時間にわたり集中力を維持しながら現場で身体を動かし続ける作業者は、まさにアスリートです。そんな現場を支える一つの手段として、スポーツ要素を取り入れることには大きな可能性があると考えています。

当社はこれまで、INNER-FACTとのコラボや、藤枝MYFCと連携した地域向けフットサルイベントの開催、社内でのスポーツ推進施策などを通じ、「町工場×スポーツ」という独自の視点から発信を続けてきました。`,
    companyProfile: {
      name: "杉村精工株式会社",
      representative: "代表取締役 杉村学",
      address: "静岡県焼津市中新田1600",
      established: "1949年7月",
      capital: "1,200万円",
      business:
        "産業機械のオーダーメイド製造（機械設計・金属部品加工・精密組立）",
      website: "https://sugimura-seiko.jp/",
    },
    contactInfo: {
      department: "杉村精工株式会社",
      person: "広報担当：杉村 岳",
      email: "gaku@sugimura-seiko.jp",
      tel: "054-624-4700",
      website: "https://sugimura-seiko.jp/",
    },
  },
